...
public:
    ...
    static LogicalPlan addStatisticBuild(LogicalPlan queryPlan, const std::shared_ptr<Windowing::WindowType>& windowType,
    ...
    static LogicalPlan addStatProbeOp(LogicalOperator probe, const LogicalPlan& queryPlan);
