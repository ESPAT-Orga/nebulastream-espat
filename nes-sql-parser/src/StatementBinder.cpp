...
public:
    ...
    std::string bindIdentifier(AntlrSQLParser::StrictIdentifierContext* strictIdentifier) const
    {
        ...
        INVARIANT(false, "Unknown identifier type, was neither valid quoted or unquoted, is the grammar out of sync with the binder?");
    }
    ...
    Literal bindLiteral(AntlrSQLParser::ConstantContext* literalAST) const
    {
        ...
        INVARIANT(false, "Unknow literal type, is the binder out of sync or a nullptr was passed");
    }
    ...
    StatementOutputFormat bindFormat(AntlrSQLParser::ShowFormatContext* formatAST) const
    {
        ...
        INVARIANT(false, "Invalid format {}", formatAST->getText());
    }
