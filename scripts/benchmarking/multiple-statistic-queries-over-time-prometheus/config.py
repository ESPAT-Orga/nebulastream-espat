...
### Per-run query counts. TOTAL_QUERIES_PER_RUN sets the shared default; override per run via
### TOTAL_QUERIES_STATISTIC_BUILD / TOTAL_QUERIES_PROMETHEUS_SINK (useful for smoke tests).
_default_total = int(os.environ.get("TOTAL_QUERIES_PER_RUN", 20))
...
CONDITION_BUDGETS = {
    ...
    "edge_heavy": {"cpus": os.environ.get("EDGE_HEAVY_CPUS", "8"),     "memory": os.environ.get("EDGE_HEAVY_MEMORY", "8g")},
    "edge_light": {"cpus": os.environ.get("EDGE_LIGHT_CPUS", "4"),     "memory": os.environ.get("EDGE_LIGHT_MEMORY", "4g")},
    "sensor":     {"cpus": os.environ.get("SENSOR_CPUS", "1"),         "memory": os.environ.get("SENSOR_MEMORY", "1g")},
}
