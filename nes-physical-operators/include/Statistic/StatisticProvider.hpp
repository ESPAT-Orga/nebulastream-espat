...
/// | ----------- 64bit ----------- --- | ------- 32bit -------  | --- metaDataSize ---  | --- totalSizeOfMemArea - metaDataSize ---  |
class StatisticProviderIteratorImpl
{
public:
    ...
    virtual Nautilus::Record operator*() const = 0;
...
protected:
    ...
    nautilus::val<uint64_t> sizeOfTotalAreaSize = 8;
    nautilus::val<uint64_t> sizeOfMetaDataSize = 4;
