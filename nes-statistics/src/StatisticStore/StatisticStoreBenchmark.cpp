...
->Args({DEFAULT, 10, 1, 8, 100, 1024})
->Args({DEFAULT, 10, 10, 8, 100, 1024})
->Args({DEFAULT, 10, 10, 8, 1000, 1024})
->Args({DEFAULT, 10, 10, 8, 100, 100 * 1024})
->Args({DEFAULT, 100, 1, 8, 100, 1024})
->Args({DEFAULT, 100, 10, 8, 100, 1024})
->Args({DEFAULT, 1000, 1, 8, 100, 1024})
->Args({DEFAULT, 1000, 10, 8, 100, 1024})
->Args({WINDOW, 10, 1, 8, 100, 1024})
->Args({WINDOW, 10, 10, 8, 100, 1024})
->Args({WINDOW, 10, 10, 8, 1000, 1024})
->Args({WINDOW, 10, 10, 8, 100, 100 * 1024})
->Args({WINDOW, 100, 1, 8, 100, 1024})
->Args({WINDOW, 100, 10, 8, 100, 1024})
->Args({WINDOW, 1000, 1, 8, 100, 1024})
->Args({WINDOW, 1000, 10, 8, 100, 1024})
->Args({SUB_STORES, 10, 1, 8, 100, 1024})
->Args({SUB_STORES, 10, 10, 8, 100, 1024})
->Args({SUB_STORES, 10, 10, 8, 1000, 1024})
->Args({SUB_STORES, 10, 10, 8, 100, 100 * 1024})
->Args({SUB_STORES, 100, 1, 8, 100, 1024})
->Args({SUB_STORES, 100, 10, 8, 100, 1024})
->Args({SUB_STORES, 1000, 1, 8, 100, 1024})
->Args({SUB_STORES, 1000, 10, 8, 100, 1024})
    ->Args({DEFAULT, 10, 1, 4, 100, 1024})
    ->Args({DEFAULT, 10, 10, 4, 100, 1024})
    ->Args({DEFAULT, 10, 10, 4, 1000, 1024})
    ->Args({DEFAULT, 10, 10, 4, 100, 100 * 1024})
    ->Args({DEFAULT, 100, 1, 4, 100, 1024})
    ->Args({DEFAULT, 100, 10, 4, 100, 1024})
    ->Args({DEFAULT, 1000, 1, 4, 100, 1024})
    ->Args({DEFAULT, 1000, 10, 4, 100, 1024})
    ->Args({WINDOW, 10, 1, 4, 100, 1024})
    ->Args({WINDOW, 10, 10, 4, 100, 1024})
    ->Args({WINDOW, 10, 10, 4, 1000, 1024})
    ->Args({WINDOW, 10, 10, 4, 100, 100 * 1024})
    ->Args({WINDOW, 100, 1, 4, 100, 1024})
    ->Args({WINDOW, 100, 10, 4, 100, 1024})
    ->Args({WINDOW, 1000, 1, 4, 100, 1024})
    ->Args({WINDOW, 1000, 10, 4, 100, 1024})
    ->Args({SUB_STORES, 10, 1, 4, 100, 1024})
    ->Args({SUB_STORES, 10, 10, 4, 100, 1024})
    ->Args({SUB_STORES, 10, 10, 4, 1000, 1024})
    ->Args({SUB_STORES, 10, 10, 4, 100, 100 * 1024})
    ->Args({SUB_STORES, 100, 1, 4, 100, 1024})
    ->Args({SUB_STORES, 100, 10, 4, 100, 1024})
    ->Args({SUB_STORES, 1000, 1, 4, 100, 1024})
    ->Args({SUB_STORES, 1000, 10, 4, 100, 1024})
->Args({DEFAULT, 10, 1, 2, 100, 1024})
->Args({DEFAULT, 10, 10, 2, 100, 1024})
->Args({DEFAULT, 10, 10, 2, 1000, 1024})
->Args({DEFAULT, 10, 10, 2, 100, 100 * 1024})
->Args({DEFAULT, 100, 1, 2, 100, 1024})
->Args({DEFAULT, 100, 10, 2, 100, 1024})
->Args({DEFAULT, 1000, 1, 2, 100, 1024})
->Args({DEFAULT, 1000, 10, 2, 100, 1024})
->Args({WINDOW, 10, 1, 2, 100, 1024})
->Args({WINDOW, 10, 10, 2, 100, 1024})
->Args({WINDOW, 10, 10, 2, 1000, 1024})
->Args({WINDOW, 10, 10, 2, 100, 100 * 1024})
->Args({WINDOW, 100, 1, 2, 100, 1024})
->Args({WINDOW, 100, 10, 2, 100, 1024})
->Args({WINDOW, 1000, 1, 2, 100, 1024})
->Args({WINDOW, 1000, 10, 2, 100, 1024})
->Args({SUB_STORES, 10, 1, 2, 100, 1024})
->Args({SUB_STORES, 10, 10, 2, 100, 1024})
->Args({SUB_STORES, 10, 10, 2, 1000, 1024})
->Args({SUB_STORES, 10, 10, 2, 100, 100 * 1024})
->Args({SUB_STORES, 100, 1, 2, 100, 1024})
->Args({SUB_STORES, 100, 10, 2, 100, 1024})
->Args({SUB_STORES, 1000, 1, 2, 100, 1024})
->Args({SUB_STORES, 1000, 10, 2, 100, 1024})
->Args({DEFAULT, 10, 1, 16, 100, 1024})
->Args({DEFAULT, 10, 10, 16, 100, 1024})
->Args({DEFAULT, 10, 10, 16, 1000, 1024})
->Args({DEFAULT, 10, 10, 16, 100, 100 * 1024})
->Args({DEFAULT, 100, 1, 16, 100, 1024})
->Args({DEFAULT, 100, 10, 16, 100, 1024})
->Args({DEFAULT, 1000, 1, 16, 100, 1024})
->Args({DEFAULT, 1000, 10, 16, 100, 1024})
->Args({WINDOW, 10, 1, 16, 100, 1024})
->Args({WINDOW, 10, 10, 16, 100, 1024})
->Args({WINDOW, 10, 10, 16, 1000, 1024})
->Args({WINDOW, 10, 10, 16, 100, 100 * 1024})
->Args({WINDOW, 100, 1, 16, 100, 1024})
->Args({WINDOW, 100, 10, 16, 100, 1024})
->Args({WINDOW, 1000, 1, 16, 100, 1024})
->Args({WINDOW, 1000, 10, 16, 100, 1024})
->Args({SUB_STORES, 10, 1, 16, 100, 1024})
->Args({SUB_STORES, 10, 10, 16, 100, 1024})
->Args({SUB_STORES, 10, 10, 16, 1000, 1024})
->Args({SUB_STORES, 10, 10, 16, 100, 100 * 1024})
->Args({SUB_STORES, 100, 1, 16, 100, 1024})
->Args({SUB_STORES, 100, 10, 16, 100, 1024})
->Args({SUB_STORES, 1000, 1, 16, 100, 1024})
->Args({SUB_STORES, 1000, 10, 16, 100, 1024});
...
->Args({DEFAULT, 10, 1, 100, 100, 1024, 2})
->Args({DEFAULT, 10, 10, 100, 100, 1024, 2})
->Args({DEFAULT, 10, 10, 50, 100, 1024, 2})
->Args({DEFAULT, 100, 1, 100, 100, 1024, 2})
->Args({DEFAULT, 100, 10, 100, 100, 1024, 2})
->Args({DEFAULT, 1000, 1, 100, 100, 1024, 2})
->Args({DEFAULT, 1000, 10, 100, 100, 1024, 2})
->Args({WINDOW, 10, 1, 100, 100, 1024, 2})
->Args({WINDOW, 10, 10, 100, 100, 1024, 2})
->Args({WINDOW, 10, 10, 50, 100, 1024, 2})
->Args({WINDOW, 100, 1, 100, 100, 1024, 2})
->Args({WINDOW, 100, 10, 100, 100, 1024, 2})
->Args({WINDOW, 1000, 1, 100, 100, 1024, 2})
->Args({WINDOW, 1000, 10, 100, 100, 1024, 2})
->Args({SUB_STORES, 10, 1, 100, 100, 1024, 2})
->Args({SUB_STORES, 10, 10, 100, 100, 1024, 2})
->Args({SUB_STORES, 10, 10, 50, 100, 1024, 2})
->Args({SUB_STORES, 100, 1, 100, 100, 1024, 2})
->Args({SUB_STORES, 100, 10, 100, 100, 1024, 2})
->Args({SUB_STORES, 1000, 1, 100, 100, 1024, 2})
->Args({SUB_STORES, 1000, 10, 100, 100, 1024, 2})
->Args({DEFAULT, 10, 1, 100, 100, 1024, 4})
->Args({DEFAULT, 10, 10, 100, 100, 1024, 4})
->Args({DEFAULT, 10, 10, 50, 100, 1024, 4})
->Args({DEFAULT, 100, 1, 100, 100, 1024, 4})
->Args({DEFAULT, 100, 10, 100, 100, 1024, 4})
->Args({DEFAULT, 1000, 1, 100, 100, 1024, 4})
->Args({DEFAULT, 1000, 10, 100, 100, 1024, 4})
->Args({WINDOW, 10, 1, 100, 100, 1024, 4})
->Args({WINDOW, 10, 10, 100, 100, 1024, 4})
->Args({WINDOW, 10, 10, 50, 100, 1024, 4})
->Args({WINDOW, 100, 1, 100, 100, 1024, 4})
->Args({WINDOW, 100, 10, 100, 100, 1024, 4})
->Args({WINDOW, 1000, 1, 100, 100, 1024, 4})
->Args({WINDOW, 1000, 10, 100, 100, 1024, 4})
->Args({SUB_STORES, 10, 1, 100, 100, 1024, 4})
->Args({SUB_STORES, 10, 10, 100, 100, 1024, 4})
->Args({SUB_STORES, 10, 10, 50, 100, 1024, 4})
->Args({SUB_STORES, 100, 1, 100, 100, 1024, 4})
->Args({SUB_STORES, 100, 10, 100, 100, 1024, 4})
->Args({SUB_STORES, 1000, 1, 100, 100, 1024, 4})
->Args({SUB_STORES, 1000, 10, 100, 100, 1024, 4})
->Args({DEFAULT, 10, 1, 100, 100, 1024, 8})
->Args({DEFAULT, 10, 10, 100, 100, 1024, 8})
->Args({DEFAULT, 10, 10, 50, 100, 1024, 8})
->Args({DEFAULT, 100, 1, 100, 100, 1024, 8})
->Args({DEFAULT, 100, 10, 100, 100, 1024, 8})
->Args({DEFAULT, 1000, 1, 100, 100, 1024, 8})
->Args({DEFAULT, 1000, 10, 100, 100, 1024, 8})
->Args({WINDOW, 10, 1, 100, 100, 1024, 8})
->Args({WINDOW, 10, 10, 100, 100, 1024, 8})
->Args({WINDOW, 10, 10, 50, 100, 1024, 8})
->Args({WINDOW, 100, 1, 100, 100, 1024, 8})
->Args({WINDOW, 100, 10, 100, 100, 1024, 8})
->Args({WINDOW, 1000, 1, 100, 100, 1024, 8})
->Args({WINDOW, 1000, 10, 100, 100, 1024, 8})
->Args({SUB_STORES, 10, 1, 100, 100, 1024, 8})
->Args({SUB_STORES, 10, 10, 100, 100, 1024, 8})
->Args({SUB_STORES, 10, 10, 50, 100, 1024, 8})
->Args({SUB_STORES, 100, 1, 100, 100, 1024, 8})
->Args({SUB_STORES, 100, 10, 100, 100, 1024, 8})
->Args({SUB_STORES, 1000, 1, 100, 100, 1024, 8})
->Args({SUB_STORES, 1000, 10, 100, 100, 1024, 8})
->Args({DEFAULT, 10, 1, 100, 100, 1024, 16})
->Args({DEFAULT, 10, 10, 100, 100, 1024, 16})
->Args({DEFAULT, 10, 10, 50, 100, 1024, 16})
->Args({DEFAULT, 100, 1, 100, 100, 1024, 16})
->Args({DEFAULT, 100, 10, 100, 100, 1024, 16})
->Args({DEFAULT, 1000, 1, 100, 100, 1024, 16})
->Args({DEFAULT, 1000, 10, 100, 100, 1024, 16})
->Args({WINDOW, 10, 1, 100, 100, 1024, 16})
->Args({WINDOW, 10, 10, 100, 100, 1024, 16})
->Args({WINDOW, 10, 10, 50, 100, 1024, 16})
->Args({WINDOW, 100, 1, 100, 100, 1024, 16})
->Args({WINDOW, 100, 10, 100, 100, 1024, 16})
->Args({WINDOW, 1000, 1, 100, 100, 1024, 16})
->Args({WINDOW, 1000, 10, 100, 100, 1024, 16})
->Args({SUB_STORES, 10, 1, 100, 100, 1024, 16})
->Args({SUB_STORES, 10, 10, 100, 100, 1024, 16})
->Args({SUB_STORES, 10, 10, 50, 100, 1024, 16})
->Args({SUB_STORES, 100, 1, 100, 100, 1024, 16})
->Args({SUB_STORES, 100, 10, 100, 100, 1024, 16})
->Args({SUB_STORES, 1000, 1, 100, 100, 1024, 16})
->Args({SUB_STORES, 1000, 10, 100, 100, 1024, 16});
