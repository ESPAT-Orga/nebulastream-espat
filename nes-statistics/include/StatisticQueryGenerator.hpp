...
public:
    ...
    /// The statisticId is provided by the StatisticManager and uniquely identifies this statistic.
    [[nodiscard]] virtual LogicalPlan generateQuery(
        const RequestStatisticBuildStatement& request, StatisticTuple::StatisticId statisticId, const std::string& coordinatorAddress) const
        = 0;
