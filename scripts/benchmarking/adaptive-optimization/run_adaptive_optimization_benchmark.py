...
#   bidValue < 10.45  →  selectivity ~0.01  (bidValue ~ N(50, 17))
#   price    < 888.49 →  selectivity ~0.99  (price    ~ N(500, 167))
# SETUP_SQL uses bidValue-first; REVERSED_QUERY_SQL swaps to price-first.
