...
public:
    explicit StatisticStoreReader(
        ...
        Record::RecordFieldIdentifier statisticIdFieldName,
        Record::RecordFieldIdentifier statisticStartTsFieldName,
        Record::RecordFieldIdentifier statisticEndTsFieldName,
        Record::RecordFieldIdentifier statisticNumberOfSeenTuplesFieldName,
