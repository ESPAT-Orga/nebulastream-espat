...
struct LowerToPhysicalCountMinSketchProbe : AbstractLoweringRule
{
    explicit LowerToPhysicalCountMinSketchProbe(QueryExecutionConfiguration conf) : conf(std::move(conf)) { }
