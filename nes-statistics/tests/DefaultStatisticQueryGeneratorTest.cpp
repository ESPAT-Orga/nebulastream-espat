...
TEST_F(DefaultStatisticQueryGeneratorTest, WorkloadDomainThrowsNotYetImplemented)
{
    const RequestStatisticBuildStatement request{
        .domain
        = WorkloadDomain{.queryId = QueryId::createDistributed(DistributedQueryId{"42"}), .operatorId = OperatorId{5}, .fieldName = "field"},
        .metric = Metric::Cardinality,
        .windowSizeMs = 5000,
        .windowAdvanceMs = {},
        .eventTimeFieldName = {},
...
{
    const RequestStatisticBuildStatement request{
        .domain = InfrastructureDomain{Host{"worker1"}},
        .metric = Metric::Rate,
        .windowSizeMs = 5000,
        .windowAdvanceMs = {},
        .eventTimeFieldName = {},
