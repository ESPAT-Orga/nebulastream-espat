...
VarVal LazyValueRepresentation::parseValue() const
{
    ...
    switch (type.type)
    {
        case DataType::Type::UINT8: {
            return parseIntoNautilusRecord<uint8_t>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::UINT16: {
            return parseIntoNautilusRecord<uint16_t>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::UINT32: {
            return parseIntoNautilusRecord<uint32_t>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::UINT64: {
            return parseIntoNautilusRecord<uint64_t>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::INT8: {
            return parseIntoNautilusRecord<int8_t>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::INT16: {
            return parseIntoNautilusRecord<int16_t>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::INT32: {
            return parseIntoNautilusRecord<int32_t>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::INT64: {
            return parseIntoNautilusRecord<int64_t>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::CHAR: {
            return parseIntoNautilusRecord<char>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::BOOLEAN: {
            return parseIntoNautilusRecord<bool>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::FLOAT32: {
            return parseIntoNautilusRecord<float>(ptrToLazyValue, size, type.nullable, isNull);
        }
        case DataType::Type::FLOAT64: {
            return parseIntoNautilusRecord<double>(ptrToLazyValue, size, type.nullable, isNull);
        }
