...
Record CountMinPhysicalFunction::lower(nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    record.write(
        ...
        VariableSizedData{countMinMemory + nautilus::val<uint64_t>{4}, nautilus::val<uint64_t>{totalSizeOfSketchInBytes}});
    return record;
}
