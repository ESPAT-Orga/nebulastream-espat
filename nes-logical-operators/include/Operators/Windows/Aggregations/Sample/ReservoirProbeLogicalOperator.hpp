...
public:
    ...
    {
        static inline const DescriptorConfig::ConfigParameter<std::string> STAT_HASH{
            "statHash",
            std::nullopt,
            [](const std::unordered_map<std::string, std::string>& config) { return DescriptorConfig::tryGet(STAT_HASH, config); }};
        ...
        static inline std::unordered_map<std::string, DescriptorConfig::ConfigParameterContainer> parameterMap
            = DescriptorConfig::createConfigParameterContainerMap(STAT_HASH, SAMPLE_SCHEMA);
    };
