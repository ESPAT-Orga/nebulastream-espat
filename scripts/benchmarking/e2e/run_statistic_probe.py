...
def build_probe_trials(args, num_probe_tuples_list) -> list:
...
def _probe_banner_extras(trial: Trial) -> str:
    return (f"{trial.extras['num_statistic_ids']}id · "
            ...
            f"{trial.extras['num_probe_tuples']}tup · "
...
def _probe_run_dir_extras(trial: Trial) -> str:
    return (f"{trial.extras['num_statistic_ids']}ids_"
            ...
            f"{trial.extras['num_probe_tuples']}tuples_"
            f"{trial.extras['num_probe_repetitions']}reps")


if __name__ == "__main__":
    parser = make_argparser("Benchmark statistic probe queries.")
    parser.add_argument("--num-probe-tuples", nargs="+", type=int, default=None,
                        help="Number of probe tuples per (statistic_id, repetition) — "
                             "list, sweeps one trial per value.")
    ...
    trials = build_probe_trials(args, num_probe_tuples_list=(args.num_probe_tuples or allNumProbeTuples))
